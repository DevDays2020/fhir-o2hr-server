...
public class RestfulServlet extends RestfulServer {
	...
	public void initialize() {
		...
		conditionResourceProvider.setFhirContext(myFhirCtx);
		...
		encounterResourceProvider.setFhirContext(myFhirCtx);
		...
		medicationResourceProvider.setFhirContext(myFhirCtx);
		...
		medicationStatementResourceProvider.setFhirContext(myFhirCtx);
		...
		medicationRequestResourceProvider.setFhirContext(myFhirCtx);
		...
		observationResourceProvider.setFhirContext(myFhirCtx);
		...
		organizationResourceProvider.setFhirContext(myFhirCtx);
		...
		patientResourceProvider.setFhirContext(myFhirCtx);
		...
		practitionerResourceProvider.setFhirContext(myFhirCtx);
		...
		procedureResourceProvider.setFhirContext(myFhirCtx);
		...
		deviceResourceProvider.setFhirContext(myFhirCtx);
		...
		listResourceProvider.setFhirContext(myFhirCtx);
		...
		locationResourceProvider.setFhirContext(myFhirCtx);
		providers.add(locationResourceProvider);

		RelatedPersonResourceProvider relatedPersonResourceProvider = myAppCtx.getBean(RelatedPersonResourceProvider.class);
		relatedPersonResourceProvider.setFhirContext(myFhirCtx);
		providers.add(relatedPersonResourceProvider);

		CompositionResourceProvider compositionResourceProvider = myAppCtx.getBean(CompositionResourceProvider.class);
		compositionResourceProvider.setFhirContext(myFhirCtx);
